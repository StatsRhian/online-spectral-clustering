...
R CMD BATCH pendigits_test.R rout/${PBS_JOBID}.Rout --no-save  # run algorithm.r (which can grab the array ID) and save R console output to file numbered by array Id i the rout directory
